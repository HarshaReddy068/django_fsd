...
class Course(models.Model):
    ...
    course_credits = models.IntegerField(validators=[MinValueValidator(0), MaxValueValidator(4)], blank=False, null=False)
...
class Student(models.Model):
    ...
    student_sem = models.IntegerField(blank=False, null=False, validators=[MinValueValidator(1), MaxValueValidator(8)])
